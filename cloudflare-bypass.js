...
process.argv.forEach(argument => {
    if (argument.includes("cookie=") && !process.argv[5].split('""')[0].includes(argument)) {
        ...
        if (argument.includes("postdata=") && !process.argv[5].split('""')[0].includes(argument)) {
            ...
            if (argument.includes("randomstring=")) {
                ...
                if (argument.includes("headerdata=")) {
                    ...
                    if (argument.slice(11).split('""')[0].includes("&")) {
                        ...
                        const headerDataArray = argument.slice(11).split('""')[0];
                        const headerField = headerDataArray.split("=")[0];
                        const headerValue = headerDataArray.split("=")[1];
                        headerbuilders[headerField ] = headerValue;
                    }
                }
            }
...
/* ANTIGO
function spoof() {
  return `${randstr.generate({ length: 1, charset: "12" })}.${randstr.generate({ length: 3, charset: "012345" })}.${randstr.generate({ length: 3, charset: "012345" })}.${randstr.generate({ length: 2, charset: "12" })}.${randstr.generate({ length: 3, charset: "012345" })}.${randstr.generate({ length: 3, charset: "012345" })}.${randstr.generate({ length: 2, charset: "12" })}.${randstr.generate({ length: 3, charset: "012345" })}.${randstr.generate({ length: 3, charset: "012345" })}`;
}
*/
...
const cplist = [
  ...
  "TLS_AES_256_GCM_SHA384:ECDHE-RSA-AES256-GCM-SHA384:DHE-RSA-AES256-GCM-SHA384",
  "ECDHE-RSA-CHACHA20-POLY1305",
  "DHE-RSA-CHACHA20-POLY1305",
  "TLS_AES_256_GCM_SHA384:TLS_CHACHA20_POLY1305_SHA256:TLS_AES_128_GCM_SHA256:ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES128-SHA256:ECDHE-RSA-AES128-SHA:ECDHE-RSA-AES256-SHA384:ECDHE-RSA-AES256-SHA256:DHE-RSA-AES128-SHA256:DHE-RSA-AES128-SHA:DHE-RSA-AES256-SHA256:DHE-RSA-AES256-SHA:HIGH:!aNULL:!eNULL:!EXPORT:!DES:!RC4:!MD5:!PSK:!SRP:!CAMELLIA",
  "ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:DHE-DSS-AES128-GCM-SHA256:kEDH+AESGCM:ECDHE-RSA-AES128-SHA256:ECDHE-ECDSA-AES128-SHA256:ECDHE-RSA-AES128-SHA:ECDHE-ECDSA-AES128-SHA:ECDHE-RSA-AES256-SHA384:ECDHE-ECDSA-AES256-SHA384:ECDHE-RSA-AES256-SHA:ECDHE-ECDSA-AES256-SHA:DHE-RSA-AES128-SHA256:DHE-RSA-AES128-SHA:DHE-DSS-AES128-SHA256:DHE-RSA-AES256-SHA256:DHE-DSS-AES256-SHA:DHE-RSA-AES256-SHA:!aNULL:!eNULL:!EXPORT:!DES:!RC4:!3DES:!MD5:!PSK",
  "ECDHE-RSA-AES256-SHA:AES256-SHA:HIGH:!AESGCM:!CAMELLIA:!3DES:!EDH",
  "RC4-SHA:RC4:ECDHE-RSA-AES256-SHA:AES256-SHA:HIGH:!MD5:!aNULL:!EDH:!AESGCM",
  "ECDHE-RSA-AES256-SHA:RC4-SHA:RC4:HIGH:!MD5:!aNULL:!EDH:!AESGCM",
  ...
  "AES256-CCM8:CHACHA20-POLY1305-SHA256"
];
